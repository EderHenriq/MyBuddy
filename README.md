...
## 🚀 Roadmap — 800h · 6 meses · 3 Épicos

<div align="center">
<img src="https://media.giphy.com/media/2IudUHdI075HL02Pkk/giphy.gif" alt="gifprog" width="250"/>
</div>

### Epic 1 — Base & Migração
- [ ] Refatoração com Lombok
- [ ] Autenticação federada via **Keycloak** (OpenID Connect)
- [ ] Setup **Angular** + componentes + design system
- [ ] Containerização com **Docker Compose**
- [ ] Cobertura de testes backend ≥ 30%

### Epic 2 — Mobile & Pagamentos
- [ ] Angular: integração completa com API
- [ ] **Mercado Pago** (backend + frontend)
- [ ] App mobile com **Flutter** (iOS, Android e Web)
- [ ] Testes E2E com **Cypress**
- [ ] Cobertura de testes ≥ 60%

### Epic 3 — Marketplace & Finalização
- [ ] **Marketplace** completo com PostgreSQL (CRUD + regras de negócio)
- [ ] **Split Payment** via Mercado Pago
- [ ] Otimização de performance nos bancos de dados
- [ ] Documentação final + vídeo demonstrativo
...
- Java 21+
- Maven 3.8+
- MongoDB e PostgreSQL (ou Docker para subir ambos)

### Backend

```bash
git clone https://github.com/EderHenriq/MyBuddy.git
cd "MyBuddy/Back End/JavaSpring/Myb Def/Myb/Myb"

# Configure suas credenciais em application.properties
mvn spring-boot:run
```
