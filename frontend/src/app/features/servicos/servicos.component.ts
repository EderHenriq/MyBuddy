  ...
  servicos: Servico[] = [
    {
      ...
      description:
        "Clínica completa com atendimento de emergência, cirurgias e especialidades diversas.",
      isFavorite: false,
    },
    {
      id: 2,
      ...
      openHoursStr: "Aberto 24h",
      description:
        "Estrutura hospitalar avançada para o cuidado intensivo do seu melhor amigo.",
      isFavorite: true,
    },
    {
      id: 3,
      ...
      description:
        "Hotel fazenda com ampla área verde, piscina e recreação monitorada 24h.",
      isFavorite: false,
    },
    {
      id: 4,
      imageUrl:
        "https://images.unsplash.com/photo-1516366478644-84566f1e149f?auto=format&fit=crop&q=80&w=800",
      type: "Adestramento",
      ...
      description:
        "Comportamento canino e obediência com métodos de reforço positivo.",
      isFavorite: false,
    },
    {
      id: 5,
      ...
      description:
        "Atendimento exclusivo para felinos com ambiente cat-friendly certificado.",
      isFavorite: true,
    },
    {
      id: 6,
      ...
      description:
        "Seu pet se diverte e gasta energia enquanto você trabalha. Muita brincadeira e amor.",
      isFavorite: false,
    },
  ];
