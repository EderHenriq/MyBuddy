    ...
    if (role === Role.ADMIN) {
      this.notificacoesSubject.next([
        ...
        },
        {
          ...
          mensagem:
            "O relatório consolidado de adoções está pronto para download.",
          data: "Ontem",
          lida: true,
          tipo: "info",
        },
      ...
      this.notificacoesSubject.next([
        {
          ...
          mensagem:
            "Parabéns, a ONG Cão Sem Dono aprovou sua solicitação para a Jade!",
          data: "Há 1 hora",
          lida: false,
          tipo: "success",
        },
        {
          ...
          mensagem: "A vacina do Paçoca vence em 5 dias.",
          data: "Há 4 horas",
          lida: false,
          tipo: "warning",
        },
