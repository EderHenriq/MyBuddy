  ...
  getCampaigns(categoria?: string): Observable<CampanhaDoacao[]> {
    const path =
      categoria && categoria !== "Todos"
        ...
        : "campanhas";
    return this.api
      .get<CampanhaDoacao[]>(path)
      .pipe(catchError(() => of(this.getMockCampaigns(categoria))));
  }

  getOngsParceiras(): Observable<OngParceira[]> {
    return this.api
      .get<OngParceira[]>("ongs/parceiras")
      .pipe(catchError(() => of(this.getMockOngs())));
  }
    ...
    const all: CampanhaDoacao[] = [
      {
        ...
        descricao:
          "O Bolinha precisa de uma cirurgia urgente na pata traseira. Ajude!",
        meta: 3000,
        arrecadado: 1800,
        organizacaoId: 1,
        categoria: "Cirurgias",
      ...
      },
      {
        ...
        descricao:
          "Nosso abrigo está precisando de ração para alimentar 40 felinos resgatados.",
        meta: 1200,
        arrecadado: 700,
        organizacaoId: 2,
      ...
      },
      {
        ...
        descricao:
          "A cachorrinha Mel foi resgatada e precisa de tratamento contínuo.",
        meta: 2400,
        arrecadado: 2400,
        organizacaoId: 1,
      ...
      },
      {
        ...
        descricao:
          "Precisamos reformar as instalações para oferecer mais dignidade aos animais.",
        meta: 8000,
        arrecadado: 3200,
        organizacaoId: 3,
      ...
      },
      {
        ...
        descricao:
          "Luna foi atropelada e precisa de atendimento imediato. Cada real conta!",
        meta: 1500,
        arrecadado: 900,
        organizacaoId: 2,
        categoria: "Urgente",
    ...
    return [
      {
        ...
        totalAnimais: 38,
        descricao:
          "Abrigo precisa de ração, medicamentos e voluntários para cuidados diários.",
      ...
      },
      {
        ...
        totalAnimais: 62,
        descricao:
          "Necessidade urgente de ração e recursos para cirurgias de emergência.",
        necessidades: ["Ração", "Cirurgias", "Urgente"],
        imagemUrl:
          "https://images.unsplash.com/photo-1587300003388-59208cc962cb?auto=format&fit=crop&q=80&w=200",
      },
      {
        id: 3,
        ...
        totalAnimais: 21,
        descricao:
          "Foco em castrações e controle populacional felino na região metropolitana.",
