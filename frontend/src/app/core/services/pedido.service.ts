...
export class PedidoService {
  ...
  private obterCuponsLocais(): any[] {
    ...
    if (!data) {
      const inicial = [
        { id: 1, codigo: "BUDDY10", percentualDesconto: 10.0, ativo: true, dataInicio: "2026-01-01", dataExpiracao: "2026-12-31", valorMinimoPedido: 50.0, limiteUsoGeral: 100, usoAtual: 14 },
        { id: 2, codigo: "MEUPET20", percentualDesconto: 20.0, ativo: true, dataInicio: "2026-01-01", dataExpiracao: "2026-12-31", valorMinimoPedido: 100.0, limiteUsoGeral: 50, usoAtual: 5 },
        { id: 3, codigo: "BOASVINDAS", percentualDesconto: 15.0, ativo: false, dataInicio: "2026-01-01", dataExpiracao: "2026-06-01", valorMinimoPedido: 0, limiteUsoGeral: 500, usoAtual: 500 }
      ];
